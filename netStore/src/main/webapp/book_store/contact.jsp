...
<div id="wrap">
       ...
       <div class="center_content">
       	<div class="left_content">
            <div class="title"><span class="title_icon"><img src="book_store/images/bullet1.gif" alt="" title="" /></span>联系我们</div>
            ...
            <p class="details">
                ...
                <div class="form_subtitle">写下您宝贵的建议</div>          
                    <div class="form_row">
                    ...
                    <div class="form_row">
                    <label class="contact"><strong>建议:</strong></label>
